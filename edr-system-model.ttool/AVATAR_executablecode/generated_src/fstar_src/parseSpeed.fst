...
let parseSpeed can_id can_dlc data  = 
    ...
    if (let v1 = data.(1ul) in let v2 = data.(2ul) in let v3 = data.(3ul) in let v4 = data.(4ul) in let v5 = data.(1ul) in let v6 = data.(2ul) in let v7 = data.(3ul) in let v8 = data.(4ul) in ((U32.eq can_id 0x1b4ul) && (U8.eq can_dlc 5uy) && (U8.gte v1 0xD0uy) && (U8.eq v2 0uy) && (U8.eq v3 0uy) && (U8.eq v4 0uy) && (U32.eq can_id 0x1b4ul) && (U8.eq can_dlc 5uy) && (U8.gte v5 0xD0uy) && (U8.eq v6 0uy) && (U8.eq v7 0uy) && (U8.eq v8 0uy))) then
